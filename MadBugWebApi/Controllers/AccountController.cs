...
using MadBugWebApi.Providers;
using MadBugWebApi.Results;
using MadBug.Domain;
...
namespace MadBugWebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            //Maange transactional Operations
            ...
            using (var t = dbContext.Database.BeginTransaction())
            {
                ...
                using (var tx2 = dataContext.Database.BeginTransaction())
                {
                    ...
                    else
                    {
                        try
                        {
                            var userApp = new User() { Id = user.Id, DisplayName = model.Email, Birthdate = null, CreatedAt = System.DateTime.Now };
